...
public class ApartmentWizardPage3 extends Page {
    ...
    public void getReviewItems(ArrayList<ReviewItem> dest) {
        dest.add(new ReviewItem(mContext.getResources().getString(R.string.main_pic), mData.getString(APARTMENT_WAS_MAIN_PIC_ADDED_DATA_KEY), getKey(), -1));
        dest.add(new ReviewItem(mContext.getResources().getString(R.string.number_of_side_pics), mData.getInt(APARTMENT_AMOUNT_OF_OTHER_PICS_DATA_KEY) + "", getKey(), -1));
    }
